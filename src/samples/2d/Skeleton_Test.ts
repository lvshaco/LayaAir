...
export class Skeleton_Test {
	...
	constructor(maincls: typeof Main) {
		...
		//Laya.loader.load("res/spine/fish_77.sk").then((templet: Templet) => {
		Laya.loader.load("res/spine/shrew_orange.sk").then((templet: Templet) => {
			//创建模式为1，可以启用换装
			this.mArmature = templet.buildArmature(2);
